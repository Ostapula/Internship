...
public class App 
{
	...
	public static int mergeSort(List<Integer> copyXs, int listSize, int left) {
		return mergeSort(copyXs, listSize, left, 0, 0, 1);
	}
	
	public static int mergeSort(List<Integer> copyXs, int listSize, int left, int mid, int right, int currSize) {
	...
	public static void merge(List<Integer> copyXs, int left, int mid, int right) {
